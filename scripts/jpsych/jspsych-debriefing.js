...
jsPsych.plugins['jspsych-debriefing'] = (function () {
  ...
  plugin.trial = function (display_element, trial) {
    ...
    +'<p>In order to control for confounding variables and better compare results across participants, the responses of other participants that you saw throughout the task were artificially generated rather than coming from real past participants. People react differently when presented with machine generated advice rather than advice from real people. As we are interested in the latter case, the deception was necessary to draw conclusions for our research question regarding decision confidence in social settings (i.e. making decisions together with other people).</p>'
    ...
    +'<p>If you would like to discuss the research or have questions, please contact:</p>'
